...
const dictionary: LabelsDictionary = {
  it: {
    ...
    piada_piccola: "PIADA PICCOLA: 1 GUSTO - 5€",
    piada_media: "PIADA MEDIA: 2 GUSTI - 6€",
    piada_grande: "PIADA GRANDE: 3 GUSTI - 7€",
    affettati: "AFFETTATI",
    verdure: "VERDURE",
    formaggi: "FORMAGGI",
  ...
  en: {
    ...
    piada_piccola: "SMALL PIADA: 1 TASTE - 5€",
    piada_media: "MEDIUM PIADA: 2 TASTES - 5€",
    piada_grande: "BIG PIADA: 3 TASTES - 5€",
    affettati: "COLD CUTS",
    verdure: "VEGETABLES",
    formaggi: "CHEESES",
